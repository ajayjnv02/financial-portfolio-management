...
Domain-level user profile, preferences, analytics

Spring Boot, GraphQL subgraph, PostgreSQL, Keycloak Integration

portfolio-service

Manage user portfolios

Spring Boot, GraphQL subgraph, PostgreSQL

investment-service

Track and analyze investments

Spring Boot, GraphQL subgraph, Cassandra, Kafka

trade-service

Trade execution & event sourcing

Spring Boot, GraphQL subgraph, Kafka, PostgreSQL

price-alert-service

Monitor prices & send alerts

Spring Boot, Redis, Kafka, REST
...
Ingest price data from external APIs

Spring Boot, REST, Kafka, Cassandra
...
Centralized Apollo GraphQL Gateway

Node.js, Apollo Server 4, Federation v2
